    ...
    <div className="p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto space-y-6">
      ...
      {selectedRoom ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {filteredRoomAssets.map((asset) => (
                <motion.div
                  ...
                  className="bg-white dark:bg-slate-900 border border-[#E2E8F0] dark:border-slate-800 rounded-2xl p-4 shadow-xs hover:shadow-md transition-all flex flex-col justify-between space-y-3"
                >
                  <div>
                    ...
                    <h4 className="text-sm font-bold text-slate-900 dark:text-white mt-2 line-clamp-2">
                      {asset.name}
                    </h4>
                    <p className="text-[11px] font-mono text-slate-400 mt-0.5">{asset.id}</p>
                  ...
                  <div className="pt-2 flex items-center justify-between gap-2 border-t border-slate-100 dark:border-slate-800">
                    ...
                    <button
                      ...
                      className="px-2.5 py-1 bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 text-[11px] font-bold rounded-lg transition-colors cursor-pointer flex items-center gap-1"
                    >
                        ...
                        return (
                          ...
                          >
                            ...
                            <div>
                              ...
                              <div className="grid grid-cols-3 gap-2 mt-3 p-2 bg-slate-50 dark:bg-slate-800/60 rounded-xl text-center">
                                <div>
        ...
        <div className="space-y-6">
          ...
          {!isAdmin && (
            <div className="p-3.5 bg-slate-100 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700 rounded-2xl flex items-center gap-3 text-xs text-slate-600 dark:text-slate-300">
              <Info className="w-4 h-4 text-blue-600 dark:text-blue-400 shrink-0" />
              <span>
                You are viewing as <strong>{currentUser?.role || 'Guest'}</strong> (View-Only mode). Block & Room creation are reserved for Administrators.
              </span>
            </div>
          )}
                ...
                >
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-2 mt-4 p-3 bg-slate-50 dark:bg-slate-800/50 rounded-xl text-center">
                      ...
                      <div className="p-2 bg-white dark:bg-slate-800 rounded-lg shadow-2xs">
                        <div className="text-[10px] font-bold uppercase text-emerald-500">Occupied</div>
